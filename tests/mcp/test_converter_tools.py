...
# These tests validate the core conversion logic, input validation,
# and Pydantic models to bring coverage above 80%.


def test_miles_to_kilometers_basic() -> None:
...
def test_response_model_fields() -> None:
